...
export const translations = {
  en: {
    ...
    hero_subtitle:
      "Clean, modern and responsive websites that help individuals and businesses stand out.",
    ...
    services_subtitle:
      "Everything you need to launch a website that works as hard as you do.",
    service1_title: "Websites",
    service1_desc:
      "Fully custom business websites built to convert visitors into customers.",
    service2_title: "Landing Pages",
    service2_desc:
      "High-impact single pages designed for campaigns, launches, and offers.",
    service3_title: "Portfolios",
    service3_desc:
      "Elegant portfolio sites for creatives, freelancers, and professionals.",
    service4_title: "Responsive Design",
    service4_desc:
      "Every project looks and works flawlessly on any device or screen size.",
    service5_title: "Ongoing Support",
    service5_desc:
      "Updates, fixes, and improvements whenever your business needs them.",
    ...
    about_text:
      "BK Web Design is a boutique web design studio building fast, modern websites for individuals and companies. We focus on clean design, clear structure, and results — every project is built to help your brand look its best online.",
    about_pillar1_title: "Simple",
    about_pillar1_desc:
      "Straightforward process, clear communication, no unnecessary complexity.",
    about_pillar2_title: "Clean",
    about_pillar2_desc:
      "Minimal, purposeful design that lets your content and brand lead.",
  ...
  ar: {
    ...
    hero_subtitle:
      "مواقع إلكترونية عصرية وسريعة الاستجابة تساعد الأفراد والشركات على التميز.",
    hero_cta: "لنعمل معًا",
    ...
    service2_desc:
      "صفحات مؤثرة مصممة خصيصًا للحملات الإعلانية والعروض وإطلاق المنتجات.",
    ...
    about_text:
      "بي كي لتصميم المواقع هو استوديو تصميم متخصص في بناء مواقع إلكترونية سريعة وعصرية للأفراد والشركات. نركز على التصميم النظيف والهيكلة الواضحة والنتائج — كل مشروع نبنيه ليجعل علامتك التجارية تبدو بأفضل شكل على الإنترنت.",
    about_pillar1_title: "بساطة",
    about_pillar1_desc: "عملية واضحة وتواصل مباشر بدون أي تعقيد غير ضروري.",
    about_pillar2_title: "نقاء",
    about_pillar2_desc:
      "تصميم بسيط وهادف يترك المجال لمحتواك وهويتك ليتصدرا المشهد.",
